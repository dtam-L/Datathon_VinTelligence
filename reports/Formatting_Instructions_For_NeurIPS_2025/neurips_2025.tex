...
\title{ Phân tích doanh thu và dự báo doanh thu }
\author{%
  Đặng Văn Tâm \\
...
\item {\bf Open access to data and code}
    ...
    \begin{itemize}
        ...
        \item Please see the NeurIPS code and data submission guidel(\url{https://nips.cc/public/guides/CodeSubmissionPolicy}) for more details.
